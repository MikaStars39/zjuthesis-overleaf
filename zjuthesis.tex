...
\documentclass[
    ...
    % Thesis Info
    StudentName     = 尹清宇,
    StudentID       = 3220105223,
    AdvisorName     = 汪运起,
    Grade           = 2022,            % only the year, no '级'
    Major           = 英语,
    Department      = 外国语学院,
    SubmitDate      = {2026年5月5日},
    MajorFormat     = general,
    ...
    % Title
    Title           = {{Comparative Study of Number Bias in Human and Large Language Models}},
    TitleEng        = {{Comparative Study of Number Bias in Human and Large Language Models}}
]{zjuthesis}

\renewcommand{\Title}{Comparative Study of Number Bias in Human and Large Language Models}
\renewcommand{\TitleEng}{Comparative Study of Number Bias in Human and Large Language Models}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{Comparative Study of Number Bias}{in Human and Large Language Models}
